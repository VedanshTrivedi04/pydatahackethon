...
export const JobCard: React.FC<JobCardProps> = ({ job, onDelete }) => {
  ...
  return (
    <Link
      to={`/jobs/${job.job_id}`}
      className="group glass-panel rounded-2xl p-5 border border-[#1f1f1f] hover:border-[#00f0ff]/50 transition-all duration-200 hover:shadow-[0_4px_25px_rgba(0,240,255,0.08)] block relative overflow-hidden bg-[#0a0a0a]"
    >
